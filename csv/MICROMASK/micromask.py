...
def write(path, row):
    ...
    for key, value in row.items():
        if key != 'body' and key == 'title':
            ...
            print(f'  - image: {value}.webp', file=file)
        elif key != 'body' and key == 'size' and value != '':
            print(f'variants:\n  - name: {value}\n    size: {value}', file=file)
        elif key != 'body' and key == 'id' and value != '':
            print(f'    price: {value}', file=file)
        elif key != 'body' and key == 'price' and value != '':
            print(f'    price: {value}', file=file)
        elif key != 'body' and key == 'discount' and value != '':
            print(f'    discount: {value}', file=file)     
        elif key != 'body' and key == 'weight' and value != '':
            print(f'    weight: {value}', file=file)
        elif key != 'body' and key == 'quantity' and value != '':
